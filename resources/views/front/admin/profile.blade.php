                     ...
                     <div class="card-body">           
						<div class="row">
							<div class="col-sm-12 col-sm-offset-3 ">
								<form method="post" id="passwordForm" class="gap-3">
									<input type="password" class="form-control mb-3" name="password1" id="password1" placeholder="Old Password" autocomplete="off">
									<input type="password" class="form-control mb-3" name="password2" id="password2" placeholder="New Password" autocomplete="off">
									<input type="password" class="form-control mb-3" name="password3" id="password3" placeholder="Comform Password" autocomplete="off">
									<div class="mb-3"><button class="btn btn-primary btn-sm" type="button">Change Password</button></div>
								</form>
							</div>
						</div><!--/row-->
                    </div>
