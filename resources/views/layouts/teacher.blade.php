        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 side__navbar">
            ...
            <div class="text-center d-none d-md-inline gap-3"><button class="btn rounded-circle border-0" id="sidebarToggle" type="button"></button></div>
                ...
                <ul class="navbar-nav text-light gap-2 " id="accordionSidebar" style="font-size: 16px;">
                    ...
                    <li class="nav-item nav__item" style="border-color: rgb(255,255,255);"><a class="nav-link nav__link" href="mySubjects/333"><i class="fa fa-book"></i><span class="nav__items" style="font-size: 16px;">Subjects</span></a></li>
                    ...
                    <li class="nav-item nav__item"><a class="nav-link nav__link " href="/profile" style="font-size: 16px;"><i class="fa fa-user"></i><span class="nav__items" style="font-size: 16px;">Profile</span></a></li>
